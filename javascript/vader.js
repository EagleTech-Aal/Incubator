...
function step(drug) {
    ...
    Plotly.d3.csv('vader-data/polarity.csv', function(err, rows){
        ...
        var data = [{
            ...
            type: 'bar',
            marker: {
              color: ['#de3b44', '#e66e60', '#ee9d7a', '#f6d096', '#feffaf', '#d2e2b3', '#a9c7b6', '#80acb9', '#538ebd']
            },
            hovertext: hover,
            hoverinfo: 'text'
        }];
        ...
        Plotly.newPlot('pol', data, layout, {modeBarButtonsToRemove: ['sendDataToCloud', 'toggleSpikelines', 'zoom2d', 'pan2d', 'select2d', 'lasso2d', 'zoomIn2d', 'zoomOut2d', 'autoScale2d', 'resetScale2d', 'hoverClosestCartesian', 'hoverCompareCartesian'], responsive: true, displaylogo: false});
    });
...
Plotly.d3.csv('results/timeline.csv', function(err, rows){
        ...
        annotations: [
            {
                ...
                xref: 'x',
                yref: 'y',
                text: '"Demi Lovato Hospitalized After Drug Overdose"<br><i>iHeartRadio</i>',
                showarrow: true,
                arrowhead: 0,
                arrowwidth: 1,
            ...
            },
            {
                ...
                xref: 'x', 
                yref: 'y',
                text: '"Vikings at Bears: Five Game-Changing Plays"<br><i>Daily Norseman</i>',
                showarrow: true,
                arrowhead: 0,
                arrowwidth: 1,
                arrowcolor: 'rgb(62,85,130)',
    ...
    Plotly.newPlot('timeline', data, layout, {modeBarButtonsToRemove: ['sendDataToCloud', 'toggleSpikelines', 'zoom2d', 'pan2d', 'select2d', 'lasso2d', 'zoomIn2d', 'zoomOut2d', 'autoScale2d', 'resetScale2d', 'hoverClosestCartesian', 'hoverCompareCartesian'], responsive: true, displaylogo: false});
});